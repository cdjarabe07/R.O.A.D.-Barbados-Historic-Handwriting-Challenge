...
def segment_image(image: Image.Image, text_direction: str, pad: int, threshold: Optional[int]):
    ...
    # Nos images sont déjà des crops de ligne unique : on saute la segmentation
    # automatique de page (qui génère de faux segments sur une image déjà pré-découpée)
    # et on traite directement toute l'image comme une seule ligne de texte.
